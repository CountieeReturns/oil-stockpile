...
OPINIONS_VIDEOS = [
    {
        "id": "istlwdjd2eI",
        "name": "党首討論「高市総理と討論／玉木代表の3つの提案」",
        "description": (
            "国民民主党代表・玉木雄一郎が、党首討論で高市総理に対し、"
            "ガソリン補助の延長と出口戦略などを提案する動画。該当箇所は3分09秒から。"
        ),
        # 日付は党首討論の実施日 2026-05-20 で確定（日経報道）。時刻は午後開催の
        # 党首討論に合わせた推定値。秒単位まで厳密にするなら yt-dlp の timestamp で確定する。
        "uploadDate": "2026-05-20T15:00:00+09:00",
    },
    {
        "id": "QwybyP2RS8A",
        "name": "モーニングライブ 5/20「ガソリン補助金はいつまで続けるのか」",
        "description": (
